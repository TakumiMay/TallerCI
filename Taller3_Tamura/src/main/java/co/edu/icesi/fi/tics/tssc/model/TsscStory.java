...
public class TsscStory implements Serializable {
	...
	@Min(value=1, message="Business value must be greater than zero", groups=ValidationTsscStory.class)
	@Column(name = "BUSINESS_VALUE")
	private BigDecimal businessValue;

	private String description;

	@Min(value=1, message="Initial Sprint must be greater than zero", groups=ValidationTsscStory.class)
	...
	@Min(value=1, message="Priority must be greater than zero", groups=ValidationTsscStory.class)
	...
	@NotNull(message="Topic is mandatory", groups=ValidationTsscStory.class)
	@ManyToOne
