...
public class TsscGame implements Serializable {
	...
	@NotBlank(message="Admin Password is mandatory", groups=ValidationTsscGame.class)
	@Column(name = "ADMIN_PASSWORD")
	private String adminPassword;

	@NotBlank(message="Guest Password is mandatory", groups=ValidationTsscGame.class)
	@Column(name = "GUEST_PASSWORD")
	private String guestPassword;

	@Min(value=1, message="Number of Groups must be greater than zero", groups=ValidationTsscGame.class)
	@Column(name = "N_GROUPS")
	private Integer nGroups = 4;

	@Min(value=1, message="Number of Sprints must be greater than zero", groups=ValidationTsscGame.class)
	@Column(name = "N_SPRINTS")
	private Integer nSprints = 4;

	@NotBlank(message="Name is mandatory", groups=ValidationTsscGame.class)
	private String name;
	...
	@NotNull(message="Scheduled Date is mandatory", groups=ValidationTsscGame.class)
	@Column(name = "SCHEDULED_DATE")
	private LocalDate scheduledDate;

	@NotNull(message="Scheduled Time is mandatory", groups=ValidationTsscGame.class)
