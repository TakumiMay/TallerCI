...
public class TsscTopic implements Serializable {
	...
	@Min(value=1, message = "Sprints must be greater than zero", groups=ValidationTsscTopic.class)
	@Column(name = "DEFAULT_SPRINTS")
	private long defaultSprints;

	@Min(value=1, message = "Groups must be greater than zero", groups=ValidationTsscTopic.class)
